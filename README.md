...
3. Add the url: `https://raw.githubusercontent.com/djcath/portainer_templates/master/Template/template.json` then go to app templates and hit refresh at the top.
